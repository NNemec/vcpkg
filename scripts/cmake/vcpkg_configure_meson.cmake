function(vcpkg_configure_meson)
    ...
    set(MESON_DEBUG_CFLAGS "${MESON_DEBUG_CFLAGS} /D_DEBUG ${MSVC_CRTFLAG}d /Z7 /Ob0 /Od /RTC1")
    set(MESON_DEBUG_CXXFLAGS "${MESON_DEBUG_CXXFLAGS} /D_DEBUG ${MSVC_CRTFLAG}d /Z7 /Ob0 /Od /RTC1")
    
    set(MESON_RELEASE_CFLAGS "${MESON_RELEASE_CFLAGS} ${MSVC_CRTFLAG} /O2 /Oi /Gy /DNDEBUG /Z7")
    set(MESON_RELEASE_CXXFLAGS "${MESON_RELEASE_CXXFLAGS} ${MSVC_CRTFLAG} /O2 /Oi /Gy /DNDEBUG /Z7")
    
    set(MESON_COMMON_LDFLAGS "${MESON_COMMON_LDFLAGS} /DEBUG") # create PDB both in release and debug mode
